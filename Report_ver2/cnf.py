...
class GrammarGUI:
    def __init__(self, root):
        ...
        tk.Button(button_frame, text="Chọn File txt", command=self.load_file, bg='#4CAF50', fg='white', font=('Arial', 10)).pack(side=tk.LEFT, padx=5)
        tk.Button(button_frame, text="Chọn Hình ảnh", command=self.load_img, bg='#4CAF50', fg='white', font=('Arial', 10)).pack(side=tk.LEFT, padx=5)
        tk.Button(button_frame, text="Chụp ảnh", command=self.capture, bg='#4CAF50', fg='white',
    ...
    def load_img(self):
        image_path = image_rendering.select_image()
        result = image_rendering.process_image(image_path)
        self.input_text.delete(1.0, tk.END)
        self.input_text.insert(tk.END, result)

    def capture(self):
        image_path = image_rendering.capture_image()
        result = image_rendering.process_image(image_path)
        self.input_text.delete(1.0, tk.END)
        self.input_text.insert(tk.END, result)
